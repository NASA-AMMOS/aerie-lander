...
@ActivityType("IDCHeatersOn")
public final class IDCHeatersOn {
  ...
  public IDCHeatersOn(final Duration duration) {
  ...
  public void run(final Mission mission) {
    ...
    powerModel.setPelState(IDC_HTR_EXT, "on");
    powerModel.setPelState(IDC_HTR_PEB, "on");
