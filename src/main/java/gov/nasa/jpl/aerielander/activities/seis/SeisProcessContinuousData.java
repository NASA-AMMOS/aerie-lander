...
/**
 * Effectively supports SEIS_PROCESS_CONT_DATA.
 */
@ActivityType("SeisProcessContinuousData")
public final class SeisProcessContinuousData {

  @Parameter
  public Duration timeout = Duration.of(20, MINUTES);

  public SeisProcessContinuousData() {}

  public SeisProcessContinuousData(final Duration timeout) {
  ...
  public void run(final Mission mission) {
    ...
    if (model.poweredOn.get() && internalVolume > LIMIT_RESOLUTION) {
