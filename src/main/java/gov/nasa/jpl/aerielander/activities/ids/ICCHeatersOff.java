...
@ActivityType("ICCHeatersOff")
public final class ICCHeatersOff {
  @Parameter
  public Duration duration = Duration.of(10, SECONDS);

  public ICCHeatersOff () {}

  public ICCHeatersOff(final Duration duration) {
  ...
  public void run(final Mission mission) {
    ...
    powerModel.setPelState(ICC_HTR_EXT, "off");
    powerModel.setPelState(ICC_HTR_PEB, "off");
