...
public class ChangeDefaultDartTest {

  private final Mission mission;

  public ChangeDefaultDartTest(final Registrar registrar) {
  ...
  public void testChangeDefault() {
    ...
    spawn(this.mission, new ChangeDefaultDart(DataConfig.DART.dwn_dart_deploy_apss_cont));
